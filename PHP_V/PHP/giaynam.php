  ...
  <body>
      ...
      <h2 style="text-align: center; margin-top:10%">THỜI TRANG NAM</h2>
      <?php
              ...
              <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  ...
                  <div class="thumbnail">
                      ...
                      <div class="caption">
                          ...
                          <p style="text-align: center;">
                              <span><a href="cart.php?page=products&action=add&id=<?php echo $row['id']; ?>" type="submit" name="submit" class="btn btn-danger">Mua</a></span>
                              <span><a href="detail.php?id=<?php echo  $row['id'];  ?>" class="btn-btn-danger">Chi
                                      tiết</a></span>
                          </p>
                      </div>
                  </div>
