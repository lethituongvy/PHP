            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="../test.php" class="btn btn-primary pull-right">Quay lại</a>

                    </div>
                    <?php
                    require('../conn.php');
                    $user_id = $_SESSION["id"];
                    $sql = "SELECT products.name, products.price ,products.images, product_order.quantity, products.price* product_order.quantity 
